...
class QGField(object):
    ...
    ylat : numpy.array
           Array of evenly-spaced latitude (in degree) of size nlat. If it is a masked array, the values ylat.data will be used.
    plev : numpy.
